...
func (in *OperandSpec) DeepCopyInto(out *OperandSpec) {
	*out = *in
	if in.WorkerTolerations != nil {
		in, out := &in.WorkerTolerations, &out.WorkerTolerations
	...
	if in.WorkerEnvs != nil {
		in, out := &in.WorkerEnvs, &out.WorkerEnvs
		*out = make([]corev1.EnvVar, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.MasterEnvs != nil {
		in, out := &in.MasterEnvs, &out.MasterEnvs
		*out = make([]corev1.EnvVar, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
