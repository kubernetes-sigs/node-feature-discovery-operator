...
import (
	...
	nfdv1alpha1 "github.com/openshift/node-feature-discovery-operator/pkg/apis/nfd/v1alpha1"
...
// blank assignment to verify that ReconcileNodeFeatureDiscovery implements reconcile.Reconciler
...
type ReconcileNodeFeatureDiscovery struct {
	...
	nodefeaturediscovery *nfdv1alpha1.NodeFeatureDiscovery
}
...
func (r *ReconcileNodeFeatureDiscovery) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	r.nodefeaturediscovery = &nfdv1alpha1.NodeFeatureDiscovery{}
	err := r.client.Get(context.TODO(), request.NamespacedName, r.nodefeaturediscovery)
	if err != nil {
